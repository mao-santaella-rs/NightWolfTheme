module.exports = function (colors) {
  const themeColors = {
    ...
    "focusBorder": colors.principal_5.hex(),
    // Overall foreground color. This color is only used if not overridden by a component.
    "foreground": colors.text.hex(),
    // Shadow color of widgets such as Find/Replace inside the editor.
    "widget.shadow": colors.principal_2.hex(),
    ...
    "editorBracketMatch.background": colors.principal_3.hex(),
    ...
    // vscode codelens
    "editorCodeLens.foreground": colors.info.hex(),
    ...
    "editorWidget.resizeBorder": colors.principal_3.hex(),
    ...
    "breadcrumb.focusForeground": colors.infoDark.hex(),
    "breadcrumb.activeSelectionForeground": colors.white.hex(),
    "breadcrumbPicker.background": colors.principal.hex(),
    ...
    "list.activeSelectionForeground": colors.principal_5.hex(),
    ...
    "list.inactiveSelectionForeground": colors.principal_5.hex(),
    ...
    "activityBar.foreground": colors.principal_3.hex(),
    ...
    "activityBarBadge.background": colors.principal_0.hex(),
    // Activity notification badge foreground color.
    "activityBarBadge.foreground": colors.principal_5.hex(),
    ...
    "editorGroupHeader.noTabsBackground": colors.contrast.hex(),
    ...
    "tab.activeBackground": colors.principal.hex(),
    ...
    "menu.foreground": colors.text.hex(),
    "menu.background": colors.principal.hex(),
    ...
    "diffEditor.insertedTextBackground": colors.succesLight.hex() + "50",
    "diffEditor.insertedTextBorder": null,
    "diffEditor.removedTextBackground": colors.dangerLight.hex() + "50",
    ...
    "peekView.border": colors.interBorder.hex(),
    ...
    "merge.incomingHeaderBackground": colors.infoLight.hex() + "65",
    ...
    "panelTitle.activeBorder": colors.principal_5.hex(),
    "panelTitle.activeForeground": colors.text.hex(),
    "panelTitle.inactiveForeground": colors.principal_3.hex(),
    ...
    "notificationCenterHeader.foreground": colors.text.hex(),
    "notificationCenterHeader.background": colors.principal.hex(),
